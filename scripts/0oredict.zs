...
val flowerarray = [<minecraft:red_flower:4>, <minecraft:red_flower:6>, <minecraft:red_flower:7>, <minecraft:red_flower:5>, <minecraft:yellow_flower>, <minecraft:red_flower>, <minecraft:red_flower:3>, <minecraft:red_flower:2>, <minecraft:red_flower:1>, <minecraft:double_plant:1>, <minecraft:double_plant:4>, <minecraft:double_plant:5>];
